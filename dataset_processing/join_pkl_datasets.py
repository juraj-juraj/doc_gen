...
def main():
    """
    Concatenate selected datasets in pkl format to one pkl file.
    ...
    parser = argparse.ArgumentParser(
        description="Join selected datasets in pkl format to one pkl"
    )
    parser.add_argument(
        "files", type=str, nargs="+", help="List of files to concatenate"
    )
